// Robot 桌面软件 — 嵌入式文件资源方案处理器工厂
// 创建嵌入式文件资源处理器, 按方案与域名拦截请求
...
namespace Robot.WebResource
{
    ...
    /// <summary>
    /// 嵌入式文件资源方案处理器工厂:创建嵌入式文件资源处理器, 按方案与域名拦截请求。
    /// </summary>
    public class EmbeddedFileResourceSchemeHandlerFactory : ResourceSchemeHandlerFactory
    {
        /// <summary>
        /// 嵌入式文件资源选项。
        /// </summary>
        ...
        /// <summary>
        /// 初始化 <see cref="EmbeddedFileResourceSchemeHandlerFactory"/> 实例。
        /// </summary>
