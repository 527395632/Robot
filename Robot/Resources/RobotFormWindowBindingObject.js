...
(function ($window) {
    ...
    const CMD_ATTR_PREFIX = "host-command";
    ...
    class InternalMethods {
        ...
        onWindowStateChanged(state) {
            ...
            htmlEl?.classList.remove("host--maximized", "host--fullscreen", "host--minimized");
            const windowState = state.toLowerCase();

            if (windowState != "normal") {
                htmlEl?.classList.add(`host--${windowState}`);
            }
        ...
        onColorSchemeChanged(mode) {
            ...
            htmlEl?.classList.remove("host-color-scheme--dark", "host-color-scheme--light");
            htmlEl?.classList.add(`host-color-scheme--${modeStr}`);
        ...
        onWindowActivated() {
            const htmlEl = document.querySelector("html");
            htmlEl?.classList.remove("host--deactivate");
            htmlEl?.classList.add("host--activated");
        ...
        onWindowDeactivate() {
            const htmlEl = document.querySelector("html");
            htmlEl?.classList.remove("host--activated");
            htmlEl?.classList.add("host--deactivate");
    ...
    class Host {
        ...
        version = {
            get Robot() {
                native function GetRobotVersion();
                return GetRobotVersion();
            },
            get Chromium() {
